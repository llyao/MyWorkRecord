...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Resources_Binding
    {
        ...
        static StackObject* Load_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Type @systemTypeInstance = (System.Type)typeof(System.Type).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            var result_of_this_method = UnityEngine.Resources.Load(@path, @systemTypeInstance);
