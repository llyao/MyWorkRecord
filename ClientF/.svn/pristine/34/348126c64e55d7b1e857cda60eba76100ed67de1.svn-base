...
namespace Quick.Code
{
    public class CodeConfig
    {
        ...
        public enum EventGenteredWidgetType
        {
            Button,
            Text,
            Image,
        ...
        public static string labelRegion = string.Format(regionStartFmt, "UI Set Label");
        public static string actionRegion = string.Format(regionStartFmt, "Events");
...
//------------------------------------------------------------------------------";
        ...
        public const string onClickSerilCode        = "\n\t\t{0}.onClick.AddListener(()=> {{ On{1}Clicked({0}.gameObject);}});\n";
        public const string onValueChangeSerilCode  = "\n\t\t{0}.onValueChanged.AddListener(On{1}ValueChanged);";

        public const string btnCallbackSerilCode        = "\tprivate void On{0}Clicked(GameObject obj)\n\t{{\n\t\tif(On{0}ClickedEvent!=null)\n\t\t\tOn{0}ClickedEvent(obj)@@\n\t}}\n";
        public const string btnCallbackActionSerilCode = "\tpublic Action<GameObject> On{0}ClickedEvent;\n";

        public const string setLabelSerilCode = "\tpublic void Set{0}Text(string str)\n\t{{\n\t\t{1}.text=str;\n\t}}\n";

        public const string eventCallbackSerilCode = "\n\tprivate void On{0}ValueChanged({1} arg)\n\t{{\n\t\tif(On{0}ValueChangedEvent!=null)\n\t\t\tOn{0}ValueChangedEvent(arg)@@\n\t}}\n";
        public const string eventCallbackActionSerilCode = "\n\tpublic Action<{1}> On{0}ValueChangedEvent;\n";
        ...
        public static string labelRegionLua = string.Format(regionStartFmtLua, "UI Set Label");
        public static string actionRegionLua = string.Format(regionStartFmtLua, "Action");
...
--------------------------------------------------------------------------------";
        ...
        public const string setLabelSerilCodeLua = "\nfunction Class:Set{0}Text(args)\n\t{1}.text=str;\nend\n";
