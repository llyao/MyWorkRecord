...
namespace ClientCore.Platform
{
	...
	public class PlatformManager : Manager<PlatformManager>
	{
		...
		private bool useFakeIdentity;
		private string fakeIdentitiy;

		public string ClientIdentity
		{
			get
			{
				return (useFakeIdentity ? fakeIdentitiy : null) ?? DeviceCode;
			}
		}
		...
		public double RealtimeSinceStartup
		{
			get
			{
				return PlatformModule.RealtimeSinceStartup;
			}
		}
		...
		public bool UseFakeIdentity
		{
			get
			{
				return useFakeIdentity;
			}
			set
			{
				useFakeIdentity = value;
			}
		}
		...
		private PlatformModule PlatformModule
		{
			get
			{
				platformModule = new WindowsPlatformModule();
		...
		public void Restart()
		{
			//AndroidCaller.Call("executeRestartApp");
		}
