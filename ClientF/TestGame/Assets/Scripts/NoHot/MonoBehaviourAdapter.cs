...
public class MonoBehaviourAdapter : CrossBindingAdaptor
{
    ...
    public class Adaptor : MonoBehaviour, CrossBindingAdaptorType
    {
        ...
        IMethod mOnDestoryMethod;
        bool mOnDestoryeMethodGot;
        void OnDestory()
        {
            if (!mOnDestoryeMethodGot)
            {
                mOnDestoryMethod = instance.Type.GetMethod("OnDestory", 0);
                mOnDestoryeMethodGot = true;
            }

            if (mOnDestoryMethod != null)
            {
                appdomain.Invoke(mOnDestoryMethod, instance, null);
            }
        }
